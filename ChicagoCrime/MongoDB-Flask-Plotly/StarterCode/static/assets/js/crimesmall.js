...
function makeResponsive() {
    ...
    var file = "/static/assets/data/crimetest.csv"
    ...
    function fileData(crimeData) {
        ...
        //     xAxis.call(bottomAxis.scale(d3.event.transform.rescaleX(xLinearScale)));
        //     yAxis.call(leftAxis.scale(d3.event.transform.rescaleY(yLinearScale)));
        //     }
